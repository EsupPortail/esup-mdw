...
public class InformationsAnnuellesWindow extends Window {
	 ...
	 */
	public InformationsAnnuellesWindow() {
		this(null, null);
	}
	 ...
	 * @param message
	 */
	public InformationsAnnuellesWindow(String message) {
		this(message, null);
	}
	 ...
	 * @param titre
	 */
	public InformationsAnnuellesWindow(String message, String titre) {
		/* Style */
		...
		/* Titre */
		if (titre == null) {
			titre = applicationContext.getMessage("informationsAnnuellesWindow.defaultTitle", null, getLocale());
		}
		setCaption(titre);

		/* Texte */
		if (message == null) {
			message = applicationContext.getMessage("informationsAnnuellesWindow.text", null, getLocale());
		}
		...
		btnFermer.setCaption(applicationContext.getMessage("informationsAnnuellesWindow.btnFermer", null, getLocale()));
